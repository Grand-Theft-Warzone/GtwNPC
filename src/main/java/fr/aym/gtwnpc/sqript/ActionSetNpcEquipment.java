...
@Action(name = "Set npc equipment",
        features = {
                @Feature(
                        ...
                        pattern = "set held item of npc {gnpc} to {item}"),
                @Feature(
                        ...
                        pattern = "set second held item of npc {gnpc} to {item}"),
                @Feature(
                        ...
                        pattern = "set head item of npc {gnpc} to {item}"),
                @Feature(
                        ...
                        pattern = "set chest item of npc {gnpc} to {item}"),
                @Feature(
                        ...
                        pattern = "set legs item of npc {gnpc} to {item}"),
                @Feature(
                        ...
                        pattern = "set feet item of npc {gnpc} to {item}"),
        })
public class ActionSetNpcEquipment extends ScriptAction {
    @Override
    public void execute(ScriptContext context) throws ScriptException {
        EntityGtwNpc npc = (EntityGtwNpc) getParameter(1, context);
        ScriptExpression expression = getParameter(2);
        ItemStack item = expression.get(context, TypeItemStack.class).getObject();
