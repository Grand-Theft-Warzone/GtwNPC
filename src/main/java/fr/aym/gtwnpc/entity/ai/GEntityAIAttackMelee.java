...
public class GEntityAIAttackMelee extends EntityAIBase {
    World world;
    ...
    public GEntityAIAttackMelee(EntityCreature creature, double speedIn, boolean useLongMemory)
    {
    ...
    public double getSpeedTowardsTarget() {
