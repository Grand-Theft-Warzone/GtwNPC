...
public class GEntityAIFollowPlayer extends EntityAIBase {
    ...
    public GEntityAIFollowPlayer(EntityGtwNpc tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
    ...
    public boolean shouldExecute() {
        EntityLivingBase entitylivingbase = this.tameable.getEntityToFollow();
    ...
    public boolean shouldContinueExecuting() {
        return !this.petPathfinder.noPath() && this.owner != null && this.tameable.getDistanceSq(this.owner) > (double) (this.maxDist * this.maxDist);
    }
