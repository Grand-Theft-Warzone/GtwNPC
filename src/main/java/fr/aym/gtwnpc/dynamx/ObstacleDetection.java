...
public class ObstacleDetection {
    ...
    public void detectObstacles() {
        ...
        int checkFar2 = mySpeed > 35 ? 16 : mySpeed > 20 ? 9 : mySpeed > 5 ? 7 : mySpeed > 2 ? 4 : 2;
    ...
    public List<AIRaycast> createRayVectors(float rayDistance) {
        ...
        for (float a = angleStart; a <= angleEnd; a += angleIncrement) {
            ...
            rayVec2.addLocal(origin);
            vectors.add(new AIRaycast(entity, new com.jme3.math.Vector3f(origin), new com.jme3.math.Vector3f(rayVec2), false));
        }
        return vectors;
    }
